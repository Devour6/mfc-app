...
// color-string format (string[][]). Call initRealSprites() once at startup
// to replace placeholder sprites globally.
...
// Convert each palette-indexed frame to renderer-compatible color strings
