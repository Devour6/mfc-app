...
export default function RealTimeFightMetrics({
 ...
 <motion.div
 className="bg-gradient-to-r from-green-500 to-green-400 h-3"
 style={{ 
 ...
 className="absolute -top-1 -bottom-1 left-0 right-0 bg-red-500/20"
 />
 )}
 </div>
 ...
 <div className="w-full bg-gray-700 h-3">
 <motion.div
 className="bg-gradient-to-r from-blue-500 to-blue-400 h-3"
 style={{ 
 ...
 className="absolute top-0 left-0 right-0 bg-yellow-500/90 text-black p-2 text-center font-bold"
 >
 🔥 MOMENTUM SHIFT! 🔥
