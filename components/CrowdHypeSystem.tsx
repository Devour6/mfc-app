...
"K-O! K-O! K-O!"
 ...
 return (
 <div className="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm p-4 border border-gray-600">
 {/* Crowd Header */}
 ...
 <div className="relative bg-gray-800 h-3 overflow-hidden">
 <motion.div
 className="h-full"
 style={{ 
 ...
 className="bg-purple-900/30 border border-purple-500/30 p-3 mb-4"
 >
...
&ldquo;{activeChant.text}&rdquo;
 ...
 exit={{ opacity: 0, x: -20 }}
 className="flex items-center space-x-2 bg-black/40 px-2 py-1"
 >
 <div 
