...
export default function LiveBettingInterface({
 ...
 className="bg-gray-900/80 backdrop-blur-lg p-4 border border-gray-700"
 >
 ...
 className={`p-2 text-sm font-semibold transition-colors ${
 ...
 className="w-full bg-gray-800 border border-gray-600 px-3 py-2 text-white"
 min="1"
 />
 </div>
 ...
 className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-4 py-2 font-semibold transition-colors"
 >
 Place Bet
 </motion.button>
