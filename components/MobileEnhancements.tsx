...
export function MobileFightControls({ 
 ...
 <motion.div
 className="bg-black/80 backdrop-blur-sm p-3 flex justify-center items-center space-x-6"
 animate={{
 ...
 className="bg-green-600 hover:bg-green-700 text-white p-4 text-2xl active:scale-95 transition-all"
 ...
 <div className="w-16 bg-gray-700 h-2">
 <motion.div
 ...
 className="bg-red-600 hover:bg-red-700 text-white p-4 text-2xl active:scale-95 transition-all"
 whileHover={{ scale: 1.1 }}
 whileTap={{ scale: 0.9 }}
 >
 👎
 ...
 className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-yellow-500 text-black px-4 py-2 font-bold"
 >
...
export function MobileMiniView({ 
 ...
 className="fixed top-4 right-4 z-50 bg-black overflow-hidden border-2 border-white/20"
 ...
 className="absolute top-2 right-2 bg-white/20 text-white w-8 h-8 flex items-center justify-center text-sm"
 >
 ⛶
 </button>
 </div>
 ...
 <button
 onClick={onToggleMinimize}
 className="md:hidden absolute top-4 right-4 bg-black/50 text-white w-10 h-10 flex items-center justify-center z-10"
 >
 ⌃
 </button>
 </motion.div>
...
export function MobileBettingQuickActions({ 
 ...
 className="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-3 text-sm font-bold transition-all"
 whileTap={{ scale: 0.95 }}
 ...
 className="w-full bg-red-600 hover:bg-red-700 text-white py-2 px-3 text-sm font-bold transition-all"
 whileTap={{ scale: 0.95 }}
 disabled={balance < amount}
 >
 ${amount}
