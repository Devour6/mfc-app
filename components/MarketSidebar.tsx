...
export default function MarketSidebar({
 ...
 className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 font-semibold transition-colors"
 >
 ...
 className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 font-semibold transition-colors"
 >
