...
export default function AIPredictionEngine({
 ...
 return (
 <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-sm p-4 border border-purple-500/30">
 {/* AI Header */}
 ...
 {/* Current Prediction */}
 {currentPrediction && (
 <div className="bg-black/40 p-3 mb-4">
 ...
 className="bg-black/60 p-3 border-l-3"
